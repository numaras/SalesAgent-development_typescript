...
import type { AllowedFormats, CompanionDeliveryOption, ComputedStatus, DeliveryRateType, EnvironmentType, LineItemType, ProgrammaticCreativeSource, RoadblockingType, SkippableAdType } from "../../common/enums";
import type { AppliedLabel, BaseCustomFieldValue, CreativePlaceholder, DeliveryData, DeliveryIndicator, FrequencyCap, Goal, GrpSettings, Money, Targeting, ThirdPartyMeasurementSettings } from "../../common/types";
import type { BuyerPermissionType, NegotiationRole, RateType, ReservationStatus } from "./proposalLineItem.enum";
/**
