 ...
 */
export declare enum CreativePolicyViolation {
    /**
 ...
 */
export declare enum RichMediaStudioCreativeFormat {
    /**
 ...
 */
export declare enum RichMediaStudioCreativeArtworkType {
    /**
 ...
 */
export declare enum RichMediaStudioCreativeBillingAttribute {
    /**
 ...
 */
export declare enum RichMediaStudioChildAssetPropertyType {
    /**
     * SWF files
     */
    FLASH = "FLASH",
 ...
 */
export declare enum SslScanResult {
    /**
     * The value returned if the actual value is not exposed by the requested API version.
     */
    UNKNOWN = "UNKNOWN",
 ...
 */
export declare enum SslManualOverride {
    /**
     * The value returned if the actual value is not exposed by the requested API version.
     */
    UNKNOWN = "UNKNOWN",
 ...
 */
export declare enum LockedOrientation {
    /**
     * The value returned if the actual value is not exposed by the requested API version.
     */
    UNKNOWN = "UNKNOWN",
 ...
 */
export declare enum DestinationUrlType {
    /**
     * The value returned if the actual value is not exposed by the requested API version.
     */
    UNKNOWN = "UNKNOWN",
 ...
 * Image densities.
 */
export declare enum ImageDensity {
    /**
 ...
 */
export declare enum ScalableType {
    /**
     * The value returned if the actual value is not exposed by the requested API version.
     */
    UNKNOWN = "UNKNOWN",
 ...
 */
export declare enum VideoDeliveryType {
    /**
     * The value returned if the actual value is not exposed by the requested API version.
     */
    UNKNOWN = "UNKNOWN",
 ...
 */
export declare enum VastRedirectType {
    /**
...
//# sourceMappingURL=creative.enum.d.ts.map