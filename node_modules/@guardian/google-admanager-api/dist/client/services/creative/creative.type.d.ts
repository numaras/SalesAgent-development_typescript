...
import type { AppliedLabel, BaseCustomFieldValue, Size, ThirdPartyDataDeclaration } from "../../common/types";
import type { ConversionEvent_TrackingUrlsMapEntry } from "../creativeWrapper/creativeWrapper.type";
import type { AdIdType, CreativePolicyViolation, DestinationUrlType, ImageDensity, LockedOrientation, MimeType, RichMediaStudioChildAssetPropertyType, RichMediaStudioCreativeArtworkType, RichMediaStudioCreativeBillingAttribute, RichMediaStudioCreativeFormat, ScalableType, SslManualOverride, SslScanResult, VastRedirectType, VideoDeliveryType } from "./creative.enum";
/**
...
export type HasHtmlSnippetDynamicAllocationCreative = {
     ...
     */
    codeSnippet: string;
} & AdExchangeCreative & AdSenseCreative;
/**
...
export type BaseAudioCreative = {
     ...
     */
    sslManualOverride: SslManualOverride;
} & AudioCreative & AudioRedirectCreative;
/**
...
export type BaseVideoCreative = {
     ...
     */
    sslManualOverride: SslManualOverride;
} & SetTopBoxCreative & VideoCreative & VideoRedirectCreative;
/**
...
} & AspectRatioImageCreative & BaseAudioCreative & BaseImageCreative & BaseImageRedirectCreative & BaseVideoCreative & CustomCreative;
/**
...
export type BaseCreativeTemplateVariableValue = {
     ...
     */
    attributes: {
        "xsi:type": "AssetCreativeTemplateVariableValue" | "LongCreativeTemplateVariableValue" | "StringCreativeTemplateVariableValue" | "ListStringCreativeTemplateVariableValue" | "UrlCreativeTemplateVariableValue";
    };
    /**
