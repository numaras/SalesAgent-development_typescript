 ...
 */
export declare enum CreativeWrapperType {
    /**
 ...
 */
export declare enum ConversionEvent {
    /**
     * The value returned if the actual value is not exposed by the requested API version.
     */
    UNKNOWN = "UNKNOWN",
 ...
 */
export declare enum CreativeWrapperOrdering {
    /**
 ...
 */
export declare enum CreativeWrapperStatus {
    ACTIVE = "ACTIVE",
    INACTIVE = "INACTIVE"
}
//# sourceMappingURL=creativeWrapper.enum.d.ts.map