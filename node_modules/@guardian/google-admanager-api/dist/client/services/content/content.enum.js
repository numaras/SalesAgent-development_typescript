 ...
 */
var ContentStatusDefinedBy;
(function (ContentStatusDefinedBy) {
    /**
     * Indicates that the status of the Content is defined by the CMS.
     */
    ContentStatusDefinedBy["CMS"] = "CMS";
    /**
...
(function (DaiIngestErrorReason) {
     ...
     */
    DaiIngestErrorReason["INVALID_INGEST_URL"] = "INVALID_INGEST_URL";
    /**
     ...
     */
    DaiIngestErrorReason["INVALID_CLOSED_CAPTION_URL"] = "INVALID_CLOSED_CAPTION_URL";
    /**
     * There is no closed caption URL for a content in the publisher's content source feed. There is no trigger for this error.
     */
    DaiIngestErrorReason["MISSING_CLOSED_CAPTION_URL"] = "MISSING_CLOSED_CAPTION_URL";
    /**
     ...
     */
    DaiIngestErrorReason["COULD_NOT_FETCH_HLS"] = "COULD_NOT_FETCH_HLS";
    /**
     ...
     */
    DaiIngestErrorReason["COULD_NOT_FETCH_SUBTITLES"] = "COULD_NOT_FETCH_SUBTITLES";
    /**
     ...
     */
    DaiIngestErrorReason["MISSING_SUBTITLE_LANGUAGE"] = "MISSING_SUBTITLE_LANGUAGE";
    /**
     ...
     */
    DaiIngestErrorReason["COULD_NOT_FETCH_MEDIA"] = "COULD_NOT_FETCH_MEDIA";
    /**
     ...
     */
    DaiIngestErrorReason["MALFORMED_MEDIA_BYTES"] = "MALFORMED_MEDIA_BYTES";
    /**
     ...
     */
    DaiIngestErrorReason["CHAPTER_TIME_OUT_OF_BOUNDS"] = "CHAPTER_TIME_OUT_OF_BOUNDS";
    /**
     * An internal error occurred while conditioning the content. There is no trigger for this error.
     */
    DaiIngestErrorReason["INTERNAL_ERROR"] = "INTERNAL_ERROR";
    /**
     ...
     */
    DaiIngestErrorReason["CONTENT_HAS_CHAPTER_TIMES_BUT_NO_MIDROLL_SETTINGS"] = "CONTENT_HAS_CHAPTER_TIMES_BUT_NO_MIDROLL_SETTINGS";
    /**
     ...
     */
    DaiIngestErrorReason["MALFORMED_MEDIA_PLAYLIST"] = "MALFORMED_MEDIA_PLAYLIST";
    /**
     * Multiple ways of denoting ad breaks were detected in a media playlist (e.g. placement opportunity tags, cue markers, etc.)
     */
    DaiIngestErrorReason["MIXED_AD_BREAK_TAGS"] = "MIXED_AD_BREAK_TAGS";
    /**
     * The ad break tags in the preconditioned content are not in the same locations across all variant playlists.
     */
    DaiIngestErrorReason["AD_BREAK_TAGS_INCONSISTENT_ACROSS_VARIANTS"] = "AD_BREAK_TAGS_INCONSISTENT_ACROSS_VARIANTS";
    /**
     ...
     */
    DaiIngestErrorReason["MALFORMED_SUBTITLES"] = "MALFORMED_SUBTITLES";
    /**
     ...
     */
    DaiIngestErrorReason["PLAYLIST_ITEM_URL_DOES_NOT_MATCH_INGEST_COMMON_PATH"] = "PLAYLIST_ITEM_URL_DOES_NOT_MATCH_INGEST_COMMON_PATH";
    /**
     * Uploading split media segments failed due to an authentication error.
     */
    DaiIngestErrorReason["COULD_NOT_UPLOAD_SPLIT_MEDIA_AUTHENTICATION_FAILED"] = "COULD_NOT_UPLOAD_SPLIT_MEDIA_AUTHENTICATION_FAILED";
    /**
     * Uploading spit media segments failed due to a connection error.
     */
    DaiIngestErrorReason["COULD_NOT_UPLOAD_SPLIT_MEDIA_CONNECTION_FAILED"] = "COULD_NOT_UPLOAD_SPLIT_MEDIA_CONNECTION_FAILED";
    /**
     * Uploading split media segments failed due to a write error.
     */
    DaiIngestErrorReason["COULD_NOT_UPLOAD_SPLIT_MEDIA_WRITE_FAILED"] = "COULD_NOT_UPLOAD_SPLIT_MEDIA_WRITE_FAILED";
    /**
     ...
     */
    DaiIngestErrorReason["PLAYLISTS_HAVE_DIFFERENT_NUMBER_OF_DISCONTINUITIES"] = "PLAYLISTS_HAVE_DIFFERENT_NUMBER_OF_DISCONTINUITIES";
    /**
     * The playlist does not have a starting PTS value. The trigger for this error is the master playlist URI.
     */
    DaiIngestErrorReason["PLAYIST_HAS_NO_STARTING_PTS_VALUE"] = "PLAYIST_HAS_NO_STARTING_PTS_VALUE";
    /**
     ...
     */
    DaiIngestErrorReason["PLAYLIST_DISCONTINUITY_PTS_VALUES_DIFFER_TOO_MUCH"] = "PLAYLIST_DISCONTINUITY_PTS_VALUES_DIFFER_TOO_MUCH";
    /**
     * A media segment has no PTS. The trigger for this error is the segment data URI.
     */
    DaiIngestErrorReason["SEGMENT_HAS_NO_PTS"] = "SEGMENT_HAS_NO_PTS";
    /**
     ...
     */
    DaiIngestErrorReason["SUBTITLE_LANGUAGE_DOES_NOT_MATCH_LANGUAGE_IN_FEED"] = "SUBTITLE_LANGUAGE_DOES_NOT_MATCH_LANGUAGE_IN_FEED";
    /**
     ...
     */
    DaiIngestErrorReason["CANNOT_DETERMINE_CORRECT_SUBTITLES_FOR_LANGUAGE"] = "CANNOT_DETERMINE_CORRECT_SUBTITLES_FOR_LANGUAGE";
    /**
     * No CDN configuration found for the content. The trigger for this error is the content's master playlist URI.
     */
    DaiIngestErrorReason["NO_CDN_CONFIGURATION_FOUND"] = "NO_CDN_CONFIGURATION_FOUND";
    /**
     ...
     */
    DaiIngestErrorReason["CONTENT_HAS_MIDROLLS_BUT_NO_SPLIT_CONTENT_CONFIG"] = "CONTENT_HAS_MIDROLLS_BUT_NO_SPLIT_CONTENT_CONFIG";
    /**
     ...
     */
    DaiIngestErrorReason["CONTENT_HAS_MIDROLLS_BUT_SOURCE_HAS_MIDROLLS_DISABLED"] = "CONTENT_HAS_MIDROLLS_BUT_SOURCE_HAS_MIDROLLS_DISABLED";
    /**
     ...
     */
    DaiIngestErrorReason["ADTS_PARSE_ERROR"] = "ADTS_PARSE_ERROR";
    /**
     ...
     */
    DaiIngestErrorReason["AAC_SPLIT_ERROR"] = "AAC_SPLIT_ERROR";
    /**
     ...
     */
    DaiIngestErrorReason["AAC_PARSE_ERROR"] = "AAC_PARSE_ERROR";
    /**
     ...
     */
    DaiIngestErrorReason["TS_PARSE_ERROR"] = "TS_PARSE_ERROR";
    /**
     ...
     */
    DaiIngestErrorReason["TS_SPLIT_ERROR"] = "TS_SPLIT_ERROR";
    /**
     ...
     */
    DaiIngestErrorReason["UNSUPPORTED_CONTAINER_FORMAT"] = "UNSUPPORTED_CONTAINER_FORMAT";
    /**
     ...
     */
    DaiIngestErrorReason["MULTIPLE_ELEMENTARY_STREAMS_OF_SAME_MEDIA_TYPE_IN_TS"] = "MULTIPLE_ELEMENTARY_STREAMS_OF_SAME_MEDIA_TYPE_IN_TS";
    /**
     ...
     */
    DaiIngestErrorReason["UNSUPPORTED_TS_MEDIA_FORMAT"] = "UNSUPPORTED_TS_MEDIA_FORMAT";
    /**
     ...
     */
    DaiIngestErrorReason["NO_IFRAMES_NEAR_CUE_POINT"] = "NO_IFRAMES_NEAR_CUE_POINT";
    /**
     ...
     */
    DaiIngestErrorReason["AC3_SPLIT_ERROR"] = "AC3_SPLIT_ERROR";
    /**
     ...
     */
    DaiIngestErrorReason["AC3_PARSE_ERROR"] = "AC3_PARSE_ERROR";
    /**
     ...
     */
    DaiIngestErrorReason["EAC3_SPLIT_ERROR"] = "EAC3_SPLIT_ERROR";
    /**
     ...
     */
    DaiIngestErrorReason["INVALID_ENCRYPTION_KEY"] = "INVALID_ENCRYPTION_KEY";
    /**
     ...
     */
    DaiIngestErrorReason["EAC3_PARSE_ERROR"] = "EAC3_PARSE_ERROR";
    /**
     * Error caused by the number of PTS being a different value than the number of cue points + 1.
     */
    DaiIngestErrorReason["CUE_POINT_COUNT_DOES_NOT_MATCH_PTS_COUNT"] = "CUE_POINT_COUNT_DOES_NOT_MATCH_PTS_COUNT";
    /**
     * The subtitle language code should not contain "$$$$$".
     */
    DaiIngestErrorReason["CLOSED_CAPTION_LANGUAGE_VALUE_INVALID"] = "CLOSED_CAPTION_LANGUAGE_VALUE_INVALID";
    /**
     * The subtitle name should not contain "$$$$$".
     */
    DaiIngestErrorReason["CLOSED_CAPTION_NAME_VALUE_INVALID"] = "CLOSED_CAPTION_NAME_VALUE_INVALID";
    /**
     ...
     */
    DaiIngestErrorReason["CLOSED_CAPTION_CHARACTERISTICS_VALUE_UNEXPECTED"] = "CLOSED_CAPTION_CHARACTERISTICS_VALUE_UNEXPECTED";
    /**
     * Closed captions for a content should be unique by 'language + name'.
     */
    DaiIngestErrorReason["CLOSED_CAPTIONS_WITH_DUPLICATE_KEYS"] = "CLOSED_CAPTIONS_WITH_DUPLICATE_KEYS";
    /**
     * The value returned if the actual value is not exposed by the requested API version.
     */
    DaiIngestErrorReason["UNKNOWN"] = "UNKNOWN";
})(DaiIngestErrorReason || (exports.DaiIngestErrorReason = DaiIngestErrorReason = {}));
//# sourceMappingURL=content.enum.js.map