 ...
 */
export declare enum AdUnitTargetWindow {
    /**
 ...
 */
export declare enum AdSenseSettingsFontFamily {
    DEFAULT = "DEFAULT",
    ARIAL = "ARIAL",
    TAHOMA = "TAHOMA",
    GEORGIA = "GEORGIA",
 ...
 */
export declare enum AdSenseSettingsFontSize {
    DEFAULT = "DEFAULT",
    SMALL = "SMALL",
    MEDIUM = "MEDIUM",
    LARGE = "LARGE"
 ...
 */
export declare enum SmartSizeMode {
    /**
     * The value returned if the actual value is not exposed by the requested API version.
     */
    UNKNOWN = "UNKNOWN",
...
//# sourceMappingURL=adUnit.enum.d.ts.map