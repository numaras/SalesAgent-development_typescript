 ...
 */
export declare enum CdnConfigurationType {
    /**
 ...
 */
export declare enum CdnConfigurationStatus {
    /**
     * The value returned if the actual value is not exposed by the requested API version.
     */
    UNKNOWN = "UNKNOWN",
 ...
 */
export declare enum OriginForwardingType {
    /**
...
//# sourceMappingURL=cdnConfiguration.enum.d.ts.map