 ...
 */
export declare enum AdBreakFillType {
    /**
 ...
 */
export declare enum DynamicAdInsertionType {
    /**
 ...
 */
export declare enum AdBreakMarkupType {
    /**
 ...
 */
export declare enum AdServingFormat {
    /**
 ...
 */
export declare enum SlateStatus {
    /**
...
//# sourceMappingURL=liveStreamEvent.enum.d.ts.map