 ...
 */
export declare enum ProposalCompanyAssociationType {
    /**
 ...
 */
export declare enum AdExchangeEnvironment {
    /**
...
//# sourceMappingURL=proposal.enum.d.ts.map