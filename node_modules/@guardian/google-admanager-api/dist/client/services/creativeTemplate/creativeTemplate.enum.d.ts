 ...
 */
export declare enum AssetCreativeTemplateVariableMimeType {
    JPG = "JPG",
    PNG = "PNG",
    GIF = "GIF",
    SWF = "SWF"
 ...
 */
export declare enum CreativeTemplateStatus {
    /**
 ...
 */
export declare enum CreativeTemplateType {
    /**
...
//# sourceMappingURL=creativeTemplate.enum.d.ts.map