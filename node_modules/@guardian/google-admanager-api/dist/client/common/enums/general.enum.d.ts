 ...
 */
export declare enum OnboardingTask {
    UNKNOWN = "UNKNOWN",
    /**
 ...
 */
export declare const EnvironmentTypeEnum: Describe<EnvironmentType>;
/**
 * Describes the roadblocking types.
 */
export declare enum RoadblockingType {
    /**
 ...
 */
export declare const RoadblockingTypeEnum: Describe<RoadblockingType>;
/**
 * The different types of skippable ads.
 */
export declare enum SkippableAdType {
    /**
     * The value returned if the actual value is not exposed by the requested API version.
     */
    UNKNOWN = "UNKNOWN",
 ...
 */
export declare const SkippableAdTypeEnum: Describe<SkippableAdType>;
/**
 ...
 */
export declare const AllowedFormatsEnum: Describe<AllowedFormats>;
/**
 * Describes the computed LineItem status that is derived from the current state of the line item.
 */
export declare enum ComputedStatus {
    /**
 ...
 */
export declare const StatusEnum: Describe<ComputedStatus>;
/**
 * Types of programmatic creative sources.
 */
export declare enum ProgrammaticCreativeSource {
    /**
 ...
 */
export declare const UnitTypeEnum: Describe<UnitType>;
//# sourceMappingURL=general.enum.d.ts.map