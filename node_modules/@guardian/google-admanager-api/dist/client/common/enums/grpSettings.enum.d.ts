 ...
 */
export declare enum GrpTargetGender {
    /**
 ...
 */
export declare const GrpTargetGenderEnum: Describe<GrpTargetGender>;
/**
 * Represents available GRP providers that a line item will have its target demographic measured by.
 */
export declare enum GrpProvider {
    /**
     * The value returned if the actual value is not exposed by the requested API version.
     */
    UNKNOWN = "UNKNOWN",
 ...
 */
export declare const GrpProviderEnum: Describe<GrpProvider>;
/**
 ...
 */
export declare enum NielsenCtvPacingType {
    /**
     * The value returned if the actual value is not exposed by the requested API version.
     */
    UNKNOWN = "UNKNOWN",
 ...
 */
export declare const NielsenCtvPacingTypeEnum: Describe<NielsenCtvPacingType>;
/**
 * Represents whose device categorization to use on Nielsen measured line item with auto-pacing enabled.
 */
export declare enum PacingDeviceCategorizationType {
    /**
     * The value returned if the actual value is not exposed by the requested API version.
     */
    UNKNOWN = "UNKNOWN",
 ...
 */
export declare const PacingDeviceCategorizationTypeEnum: Describe<PacingDeviceCategorizationType>;
//# sourceMappingURL=grpSettings.enum.d.ts.map