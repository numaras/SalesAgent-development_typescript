 ...
 */
export declare enum DeliveryTimeZone {
    /**
 ...
 */
export declare const DeliveryTimeZoneEnum: Describe<DeliveryTimeZone>;
/**
 * Represents the platform which requests and renders the ad.
 */
export declare enum RequestPlatform {
    /**
 ...
 */
export declare const RequestPlatformEnum: Describe<RequestPlatform>;
/**
 * Possible delivery rates for a LineItem, which dictate the manner in which they are served.
 */
export declare enum DeliveryRateType {
    /**
 ...
 */
export declare const DeliveryRateTypeEnum: Describe<DeliveryRateType>;
/**
 * Strategies for choosing forecasted traffic shapes to pace line items.
 */
export declare enum DeliveryForecastSource {
    /**
 ...
 */
export declare const CompanionDeliveryOptionEnum: Describe<CompanionDeliveryOption>;
//# sourceMappingURL=delivery.enum.d.ts.map