...
import { type AllowedFormats, type ChildContentEligibility, type CompanionDeliveryOption, type CompetitiveConstraintScope, type ComputedStatus, type CostType, type CreativeRotationType, type CustomPacingGoalUnit, type DeliveryForecastSource, type DeliveryRateType, type EnvironmentType, type LineItemDiscountType, type LineItemSummaryReservationStatus, type LineItemType, type ProgrammaticCreativeSource, type RoadblockingType, type SkippableAdType } from "../enums";
 ...
 */
export declare const CustomPacingCurveStruct: Describe<CustomPacingCurve>;
/**
 ...
 */
export declare const LineItemDealInfoDtoStruct: Describe<LineItemDealInfoDto>;
/**
